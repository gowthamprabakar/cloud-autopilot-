...
# Sprint 32 — Multi-tenant RBAC + Tenant Admin
app.include_router(tenant_admin.router, prefix="/api/v1")
# Sprint 32 — Simulation Report Export
...
# Sprint 34 — Audit Trail & Session History
