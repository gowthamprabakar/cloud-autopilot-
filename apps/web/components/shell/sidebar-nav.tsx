...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/dashboard/modules",     label: "Modules",      icon: LayoutDashboard, roles: ["admin", "super_admin", "analyst"] },
  ...
  { href: "/dashboard/cspm",        label: "CSPM",         icon: ShieldCheck, roles: ["admin", "super_admin", "analyst"] },
